...
public:
    ...
    void show(FrontWord word) override {
        ...
        case FrontWord::min_1:
            setFrontMatrixWord(0, 5, 8); // EINE
            show(FrontWord::nach);
            break;

        case FrontWord::min_2:
            setFrontMatrixWord(0, 7, 10); // ZWEI
            show(FrontWord::nach);
            break;

        case FrontWord::min_3:
            setFrontMatrixWord(0, 1, 4); // DREI
            show(FrontWord::nach);
            break;

        case FrontWord::min_4:
            setFrontMatrixWord(1, 7, 10); // VIER
            show(FrontWord::nach);
            break;

        case FrontWord::min_5:
            setFrontMatrixWord(1, 1, 4); // FÜNF
            show(FrontWord::nach);
            break;

        case FrontWord::min_6:
            setFrontMatrixWord(2, 6, 10); // SECHS
            show(FrontWord::nach);
            break;

        case FrontWord::min_7:
            setFrontMatrixWord(2, 1, 6); // SIEBEN
            show(FrontWord::nach);
            break;

        case FrontWord::min_8:
            setFrontMatrixWord(3, 7, 10); // ACHT
            show(FrontWord::nach);
            break;

        case FrontWord::min_9:
            setFrontMatrixWord(3, 0, 3); // NEUN
            show(FrontWord::nach);
            break;
        ...
        // words
        case FrontWord::funk:
            setFrontMatrixWord(3, 3, 6); // WLAN
            break;

        case FrontWord::minute:
        case FrontWord::minuten:
            if (_minute % 5 != 0) { // not every 5 min
                setFrontMatrixWord(4, 8, 10); // MIN
            }
            break;

        case FrontWord::vor:
        case FrontWord::v_vor:
            setFrontMatrixWord(4, 4, 6); // VOR
            break;

        case FrontWord::nach:
        case FrontWord::v_nach:
            setFrontMatrixWord(4, 0, 3); // NACH
            break;

        // quarters
        case FrontWord::viertel:
            setFrontMatrixWord(5, 0, 6); // VIERTEL
            break;

        case FrontWord::halb:
            setFrontMatrixWord(6, 7, 10); // HALB
            break;

        case FrontWord::dreiviertel:
            setFrontMatrixWord(5, 0, 10); // DREIVIERTEL
            break;

        // hours
        case FrontWord::eins:
            setFrontMatrixWord(6, 0, 3); // EINS
            break;

        case FrontWord::hour_1:
            setFrontMatrixWord(6, 1, 3); // EIN
            break;

        case FrontWord::hour_2:
            setFrontMatrixWord(6, 2, 5); // ZWEI
            break;

        case FrontWord::hour_3:
            setFrontMatrixWord(8, 4, 5); // DR
            setFrontMatrixWord(9, 4, 5); // EI
            break;
        ...
        case FrontWord::hour_5:
            setFrontMatrixWord(8, 7, 10); // FÜNF
            break;

        case FrontWord::hour_6:
            setFrontMatrixWord(7, 0, 4); // SECHS
            break;

        case FrontWord::hour_7:
            setFrontMatrixWord(7, 5, 10); // SIEBEN
            break;

        case FrontWord::hour_8:
            setFrontMatrixWord(8, 0, 3); // ACHT
            break;

        case FrontWord::hour_9:
            setFrontMatrixWord(9, 7, 10); // NEUN
            break;

        case FrontWord::hour_10:
            setFrontMatrixWord(9, 0, 3); // ZEHN
            break;

        case FrontWord::hour_11:
            setFrontMatrixWord(10, 8, 10); // ELF
            break;

        case FrontWord::hour_0:
        case FrontWord::hour_12:
            setFrontMatrixWord(10, 3, 7); // ZWÖLF
            break;
        
        case FrontWord::uhr:
            if (_minute == 0) { // only at full hours
                setFrontMatrixWord(10, 0, 2); // UHR
            }
            break;
